...
<html lang="en-US">
  <head>
    ...
    <title>Coming Soon Blog Shoecom</title>
  ...
  <div class="site-wrapper-inner">
    <div class="cover-container">
      <div class="masthead clearfix">
        ...
        <h1 class="cover-heading">Working Blog</h1>
        <p class="lead cover-copy">Hold tight We are working.</p>
        <p class="lead"><a href="index.php"><button type="button" class="btn btn-lg btn-default btn-notify">Go Back</button></a></p>
      </div>
      <div class="mastfoot">
        <div class="inner">
          <p>&copy; Shoecom. Design: shoecommedia .</p>
        </div>
      </div>
