...
?>
			...
			<div class="wrap_header">
              ...
              <select class="selection-1" size="1" name="links" onchange="window.location.href=this.value;">
                ...
                <option value="myaccount.php">Account</option>
		...
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					...
					$conn = mysql_connect("localhost", "root", "");
			//  $product_array = $db_handle->runQuery("SELECT * FROM sneakersyndicate.personal ORDER BY id ASC");
				$query="SELECT * FROM sneakersyndicate.personal WHERE cost LIKE '%$cost%' OR name LIKE '%$name%'";
				$result = mysql_query($query,$conn);

				while ($row = mysql_fetch_assoc($result, MYSQLI_ASSOC)) {
						$idproduct = $row['Products'];
						$costr = $row['cost'];
						$namer = $row['name'] ;
						$useridr=$row['userid'];
				?>
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-label">
								<img src=<?php echo $idproduct ;?> height="300px" alt="IMG-PRODUCT">
